...
class MountainCarEnv(gym.Env):
    """
    Copied from https://github.com/Farama-Foundation/Gymnasium/blob/286927923259dad30465b0bb190ae565b6f2668c/gymnasium/envs/classic_control/continuous_mountain_car.py
    and https://github.com/Farama-Foundation/MO-Gymnasium/blob/62e26a378be6151068276c7a476c1d1ed41dc91d/mo_gymnasium/envs/continuous_mountain_car/continuous_mountain_car.py
    Modified such that contexts are parameters and reward is a MO weighted scalar reward.
    ...
    * v0: Initial versions release
    ...
    def __init__(
        ...
        assert self.reward_weights.shape == self.reward_space.shape
    ...
    def step(self, action: np.ndarray):
        ...
        force = np.clip(
            np.array(action) * self.action_factor + self.action_disturbance,
            self.min_action,
            self.max_action
        ).item()
        ...
        reward[0] = 0.0 if terminated else -1.0
        ...
        return self.state, scalar_reward, terminated, False, {}
...
if __name__ == "__main__":
    env = MountainCarEnv(action_factor=1.0)
