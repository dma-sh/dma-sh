...
class CartPoleEnv(gym.Env[np.ndarray, Union[int, np.ndarray]]):
    """
    Copied from https://github.com/Farama-Foundation/Gymnasium/blob/1878f6dd7d69439dc770289a9000eed6a52b4a43/gymnasium/envs/classic_control/cartpole.py
    Modified such that env expects continuous actions and contexts are parameters.
...
if __name__ == "__main__":
    from dmash.wrappers import ContextAwareObservation
    env = CartPoleEnv()
